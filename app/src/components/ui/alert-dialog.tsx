...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        // Same scrim weighting as Dialog: 10% black disappears over a dark page.
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        data-size={size}
        className={cn(
          // Same viewport cap as Dialog: a `fixed` popup taller than the screen
          // is clipped at both ends and cannot be scrolled to.
